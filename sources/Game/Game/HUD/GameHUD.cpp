...
{
	m_currentTaskText = new GUIText(m_graphicsContext);
	...
	m_currentObjectiveText = new GUIText(m_graphicsContext);
	...
	m_interactiveHint = new GUIText(m_graphicsContext);
	...
	m_codePanel = new CodePanel(m_graphicsContext, m_defaultFont);
