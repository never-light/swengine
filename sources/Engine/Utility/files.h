...
class FileUtils {
 public:
  ...
  [[nodiscard]] static std::string getResourcesMapsPath(const std::string& mapName);
 ...
 public:
  ...
  static constexpr std::string_view RESOURCES_MAPS_PATH = "./../resources/game/resources_descs";
