...
void SkeletalAnimationState::increaseCurrentTime(float delta, const SkeletalAnimationStatesMachineVariables& variablesSet)
{
...
void SkeletalAnimationClipPoseNode::increaseCurrentTime(float delta, const SkeletalAnimationStatesMachineVariables& variablesSet)
{
