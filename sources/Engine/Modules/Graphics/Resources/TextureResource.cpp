                                                         ...
                                                         const TextureResourceParameters& parameters)
{
    ...
    std::shared_ptr<GLTexture> texture = std::make_shared<GLTexture>(parameters.type, width, height, parameters.internalFormat);
                                                                      ...
                                                                      const ParametersType& defaultParameters)
{
    ...
    if (declarationNode.child("format")) {
        GLTextureInternalFormat internalFormat = ResourceDeclHelpers::getFilteredParameterValue(declarationNode, "format",
            internalFormatsMap, GLTextureInternalFormat::RGB8);
    ...
    if (declarationNode.child("wrap")) {
        if (declarationNode.child("wrap").attribute("u")) {
            GLint wrapModeU = ResourceDeclHelpers::getFilteredParameterValue(declarationNode.child("wrap").attribute("u").as_string(),
        ...
        if (declarationNode.child("wrap").attribute("v")) {
            GLint wrapModeV = ResourceDeclHelpers::getFilteredParameterValue(declarationNode.child("wrap").attribute("v").as_string(),
        ...
        if (declarationNode.child("wrap").attribute("w")) {
            GLint wrapModeW = ResourceDeclHelpers::getFilteredParameterValue(declarationNode.child("wrap").attribute("w").as_string(),
