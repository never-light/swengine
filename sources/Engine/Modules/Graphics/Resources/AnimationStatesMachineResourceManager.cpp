...
#include "AnimationStatesMachineResourceManager.h"
...
AnimationStatesMachineResourceManager::AnimationStatesMachineResourceManager(ResourcesManager* resourcesManager)
  : ResourceManager<AnimationStatesMachine, AnimationStatesMachineConfig>(resourcesManager)
{

}

AnimationStatesMachineResourceManager::~AnimationStatesMachineResourceManager() = default;


void AnimationStatesMachineResourceManager::load(size_t resourceIndex)
{
  AnimationStatesMachineConfig* config = getResourceConfig(resourceIndex);
...
void AnimationStatesMachineResourceManager::parseConfig(size_t resourceIndex, pugi::xml_node configNode)
{
  using MachineParams = AnimationStatesMachineConfig;
...
std::shared_ptr<AnimationStatesMachineConfig::Node> AnimationStatesMachineResourceManager::createAnimationNode(
  const pugi::xml_node& node)
{
  ...
  if (nodeType == "clip") {
    ...
    return std::make_shared<AnimationStatesMachineConfig::ClipNode>(
      AnimationStatesMachineConfig::Clip(clipName, clipScale));
  }
    ...
    return std::make_shared<AnimationStatesMachineConfig::BlendClipsNode>(
...
std::shared_ptr<AnimationPoseNode> AnimationStatesMachineConfig::BlendClipsNode::getPoseNode(
  ResourceHandle<Skeleton> skeleton,
...
std::shared_ptr<AnimationPoseNode> AnimationStatesMachineConfig::ClipNode::getPoseNode(
  ResourceHandle<Skeleton> skeleton,
  AnimationStatesMachineVariables& variablesSet,
  ResourcesManager& resourceManager) const
{
